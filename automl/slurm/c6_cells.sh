...
#SBATCH --output=/home/gridsan/bmironov/lanthanidestrain/automl/logs/c6_%A_%a.out
#SBATCH --error=/home/gridsan/bmironov/lanthanidestrain/automl/logs/c6_%A_%a.err
#
