...
+0.078 to at most +0.175 (batch size 32), and at four seeds that setting
ensembles to +0.166 (per seed +0.124 +- 0.046) against +0.318 for CatBoost,
still with weight 0.00 in the blend. The set transformers are data-limited: 205
