...
#SBATCH --array=0-15
#SBATCH --output=/home/gridsan/bmironov/lanthanidestrain/automl/logs/ablate_%A_%a.out
#SBATCH --error=/home/gridsan/bmironov/lanthanidestrain/automl/logs/ablate_%A_%a.err
...
OUT="${OUT_DIR:-${REPO}/automl/artifacts/sweeps/ablation}"
mkdir -p "${OUT}"
cd "${REPO}"
