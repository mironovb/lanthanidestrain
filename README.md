...
| Learning curve over extractants (I22) | R² +0.146 → +0.196 → +0.254 → +0.301 → **+0.307** at 8 / 15 / 30 / 46 / 61 training extractants (4 seeds × 3 draws); last 33 % of data worth +0.005; doubling worth +0.01–0.04 | established; data is **not** the steep constraint | `learning_curve.py`, I22 |
